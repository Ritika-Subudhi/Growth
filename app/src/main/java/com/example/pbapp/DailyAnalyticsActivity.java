...
public class DailyAnalyticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsToolbar = findViewById(R.id.my_Feed_Toolbar1);
        ...
        linearLayoutPersonalExp = findViewById(R.id.linearLayoutPersonal);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() ){
                    ...
                    if (perPercent<50){
                        ...
                        progress_ratio_per.setText(perPercent+" %" +" used of "+perRatio + " . Status:");
                        status_Image_per.setImageResource(R.drawable.yellow);
                    }
                    else {
                        progress_ratio_per.setText(perPercent+" %" +" used of "+perRatio + " . Status:");

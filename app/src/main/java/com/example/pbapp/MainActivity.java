...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView weekBtnImageView,budgetBtnImageView,todayBtnImageView,monthBtnImageView,analyticsImageView,historyImageView;
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    remainingBudgetTv.setText("Rs " + savings);
